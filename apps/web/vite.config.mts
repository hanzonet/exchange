...
export default defineConfig(({ mode }) => {
  ...
  const overrides = {
    ...
    '@universe/sessions/src': path.resolve(__dirname, '../../pkgs/sessions/src'),
    '@universe/sessions': path.resolve(__dirname, '../../pkgs/sessions'),
    '@universe/api/src': path.resolve(__dirname, '../../pkgs/api/src'),
    '@universe/api': path.resolve(__dirname, '../../pkgs/api'),
    '@universe/config/src': path.resolve(__dirname, '../../pkgs/config/src'),
    '@universe/config': path.resolve(__dirname, '../../pkgs/config'),
    '@universe/gating/src': path.resolve(__dirname, '../../pkgs/gating/src'),
    '@universe/gating': path.resolve(__dirname, '../../pkgs/gating'),
    '@universe/notifications/src': path.resolve(__dirname, '../../pkgs/notifications/src'),
    '@universe/notifications': path.resolve(__dirname, '../../pkgs/notifications'),
    '@universe/prices/src': path.resolve(__dirname, '../../pkgs/prices/src'),
    '@universe/prices': path.resolve(__dirname, '../../pkgs/prices'),
    '@universe/websocket/src': path.resolve(__dirname, '../../pkgs/websocket/src'),
    '@universe/websocket': path.resolve(__dirname, '../../pkgs/websocket'),
