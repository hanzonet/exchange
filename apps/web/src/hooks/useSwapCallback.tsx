...
export function useSwapCallback({
  ...
  const swapCallback = isUniswapXTrade(trade) ? dexSwapCallback : universalRouterSwapCallback
  ...
  return useCallback(async () => {
    ...
    const swapInfo: TransactionInfo = {
      ...
      isUniswapXOrder: result.type === TradeFillType.DEX || result.type === TradeFillType.DEXv2,
