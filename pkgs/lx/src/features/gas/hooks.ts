...
import {
  ...
  WarningLabel,
  WarningSeverity,
} from '@luxexchange/lx/src/components/modals/WarningModal/types'
...
import { getActiveGasStrategy, hasSufficientFundsIncludingGas } from '@luxexchange/lx/src/features/gas/utils'
...
import { type DerivedSendInfo } from '@luxexchange/lx/src/features/transactions/send/types'
