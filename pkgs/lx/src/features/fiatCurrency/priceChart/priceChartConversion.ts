...
import type {
  ...
  FormattedFiatDelta,
} from '@luxexchange/lx/src/features/fiatCurrency/priceChart/formatters/shared/types'
import { createStablecoinFormatter } from '@luxexchange/lx/src/features/fiatCurrency/priceChart/formatters/stablecoinFormatter'
import { createStandardFormatter } from '@luxexchange/lx/src/features/fiatCurrency/priceChart/formatters/standardFormatter'
