export enum InterfaceEventName {
  ...
  UniswapXOrderCancelInitiated = 'LX Order Cancel Initiated',
  UniswapXOrderDetailsSheetOpened = 'LX Order Details Sheet Opened',
  UniswapXOrderPostError = 'LX Order Post Error',
  UniswapXOrderSubmitted = 'LX Order Submitted',
