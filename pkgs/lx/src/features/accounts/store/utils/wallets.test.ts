...
import { SigningCapability, Wallet } from '@luxexchange/lx/src/features/accounts/store/types/Wallet'
import { useShallowWalletComparison } from '@luxexchange/lx/src/features/accounts/store/utils/wallets'
