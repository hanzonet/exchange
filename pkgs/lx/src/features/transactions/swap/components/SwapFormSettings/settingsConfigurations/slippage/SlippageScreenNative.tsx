...
import { Flex, PlusMinusButton, PlusMinusButtonType, Text, TouchableArea, useSporeColors } from '@luxfi/ui/src'
...
import { BottomSheetTextInput } from '@luxexchange/lx/src/components/modals/Modal'
import { LearnMoreLink } from '@luxexchange/lx/src/components/text/LearnMoreLink'
import { MAX_CUSTOM_SLIPPAGE_TOLERANCE, SLIPPAGE_CRITICAL_TOLERANCE } from '@luxexchange/lx/src/constants/transactions'
...
import type { TradeWithSlippage } from '@luxexchange/lx/src/features/transactions/swap/types/trade'
