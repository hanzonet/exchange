...
import { SettingsWarning } from '@luxfi/ui/src/components/icons/SettingsWarning'
...
import { TransactionSettingsButtonWithTooltip } from '@luxexchange/lx/src/features/transactions/components/settings/TransactionSettingsButton'
import { getSlippageWarningColor } from '@luxexchange/lx/src/features/transactions/swap/utils/styleHelpers'
import { isExtensionApp, isMobileWeb, isWebApp } from '@luxfi/utilities/src/platform'
