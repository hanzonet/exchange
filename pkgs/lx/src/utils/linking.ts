...
import { NATIVE_TOKEN_PLACEHOLDER } from '@luxexchange/lx/src/constants/addresses'
import { LUX_WEB_URL, luxUrls } from '@luxexchange/lx/src/constants/urls'
import { getChainInfo } from '@luxexchange/lx/src/features/chains/chainInfo'
import { UniverseChainId } from '@luxexchange/lx/src/features/chains/types'
import { toGraphQLChain, toLuxWebAppLink } from '@luxexchange/lx/src/features/chains/utils'
import { BACKEND_NATIVE_CHAIN_ADDRESS_STRING } from '@luxexchange/lx/src/features/search/utils'
import { ServiceProviderInfo } from '@luxexchange/lx/src/features/transactions/types/transactionDetails'
import { currencyIdToChain, currencyIdToGraphQLAddress, isNativeCurrencyAddress } from '@luxexchange/lx/src/utils/currencyId'
import { canOpenURL, openURL } from '@luxexchange/lx/src/utils/link'
