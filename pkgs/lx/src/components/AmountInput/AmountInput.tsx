...
import { Input, Text } from '@luxfi/ui/src'
import { fonts } from '@luxfi/ui/src/theme'
import { useTextWidth } from '@luxexchange/lx/src/components/AmountInput/useTextWidth'
import { numericInputEnforcer } from '@luxexchange/lx/src/components/AmountInput/utils/numericInputEnforcer'
import { parseValue } from '@luxexchange/lx/src/components/AmountInput/utils/parseValue'
import { replaceSeparators } from '@luxexchange/lx/src/components/AmountInput/utils/replaceSeparators'
...
import { useOnMobileAppState } from '@luxfi/utilities/src/device/appState'
