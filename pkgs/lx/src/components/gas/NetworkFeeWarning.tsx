...
import { NetworkCostTooltip, NetworkCostTooltipDEX } from 'uniswap/src/components/gas/NetworkCostTooltip'
    ...
    <WarningInfo
      ...
      tooltipProps={{
        text: uniswapXGasFeeInfo ? (
          <NetworkCostTooltipDEX uniswapXGasFeeInfo={uniswapXGasFeeInfo} />
        ) : (
