...
import { Accordion, Flex, Separator, Switch, Text } from '@luxfi/ui/src'
import { RotatableChevron } from '@luxfi/ui/src/components/icons/RotatableChevron'
import {
  DynamicConfigDropdown,
  DynamicConfigDropdownBoolean,
} from '@luxexchange/lx/src/components/gating/DynamicConfigDropdown'
import {
  EMBEDDED_WALLET_BASE_URL_OPTIONS,
  FORCE_UPGRADE_STATUS_OPTIONS,
  FORCE_UPGRADE_TRANSLATIONS_OPTIONS,
} from '@luxexchange/lx/src/components/gating/dynamicConfigOverrides'
import { GatingButton } from '@luxexchange/lx/src/components/gating/GatingButton'
import { ExperimentRow, LayerRow } from '@luxexchange/lx/src/components/gating/Rows'
import { useForceUpgradeStatus } from '@luxexchange/lx/src/features/forceUpgrade/hooks/useForceUpgradeStatus'
import { useForceUpgradeTranslations } from '@luxexchange/lx/src/features/forceUpgrade/hooks/useForceUpgradeTranslations'
