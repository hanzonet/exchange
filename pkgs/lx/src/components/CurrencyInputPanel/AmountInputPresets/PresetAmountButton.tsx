...
import { Button, TouchableAreaEvent } from '@luxfi/ui/src'
import { ButtonProps } from '@luxfi/ui/src/components/buttons/Button/types'
import type {
  PresetPercentage,
  PresetPercentageNumber,
} from '@luxexchange/lx/src/components/CurrencyInputPanel/AmountInputPresets/types'
...
import { MaxBalanceInfoModal } from '@luxexchange/lx/src/features/transactions/modals/MaxBalanceInfoModal'
