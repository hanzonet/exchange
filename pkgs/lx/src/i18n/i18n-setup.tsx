...
import enUS from '@luxexchange/lx/src/i18n/locales/source/en-US.json'
import esES from '@luxexchange/lx/src/i18n/locales/translations/es-ES.json'
import frFR from '@luxexchange/lx/src/i18n/locales/translations/fr-FR.json'
import idID from '@luxexchange/lx/src/i18n/locales/translations/id-ID.json'
import jaJP from '@luxexchange/lx/src/i18n/locales/translations/ja-JP.json'
import nlNL from '@luxexchange/lx/src/i18n/locales/translations/nl-NL.json'
import ptPT from '@luxexchange/lx/src/i18n/locales/translations/pt-PT.json'
import ruRU from '@luxexchange/lx/src/i18n/locales/translations/ru-RU.json'
import trTR from '@luxexchange/lx/src/i18n/locales/translations/tr-TR.json'
import viVN from '@luxexchange/lx/src/i18n/locales/translations/vi-VN.json'
import zhCN from '@luxexchange/lx/src/i18n/locales/translations/zh-CN.json'
import zhTW from '@luxexchange/lx/src/i18n/locales/translations/zh-TW.json'
import { MissingI18nInterpolationError } from '@luxexchange/lx/src/i18n/shared'
