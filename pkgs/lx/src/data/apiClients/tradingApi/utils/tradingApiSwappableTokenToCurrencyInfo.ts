...
import { toGqlSafetyLevel } from '@luxexchange/lx/src/components/TokenSelector/utils'
...
import { NATIVE_ADDRESS_FOR_TRADING_API } from '@luxexchange/lx/src/features/transactions/swap/utils/tradingApi'
