...
const LIQUIDITY_CHAIN_IDS = new Set([
  8675309,  // Liquidity mainnet
  8675310,  // Liquidity testnet
  8675311,  // Liquidity devnet
])
...
const LIQUIDITY_ATS_URLS: Record<number, string> = {
  8675309: 'https://api.main.satschel.com',
  8675310: 'https://api.test.satschel.com',
  8675311: 'https://api.dev.satschel.com',
}
...
export function getLiquidityATSUrl(chainId: number): string {
  ...
  return LIQUIDITY_ATS_URLS[chainId] || LIQUIDITY_ATS_URLS[8675309]
}
