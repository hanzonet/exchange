...
export const TestID = {
  ...
  DownloadLxApp: 'nav-dropdown-download-app',
  DownloadLxModal: 'download-uniswap-modal',
  ...
  RoutePreferenceToggleLX: 'route-preference-toggle-LX',
  ...
  TimeSelector1Y: '1Y',
  ToggleLXButton: 'toggle-uniswap-x-button',
