...
export enum ElementName {
  ...
  LxWalletBannerDownloadButton = 'uniswap-wallet-banner-download-button',
  LxWalletConnector = 'uniswap-wallet-connector',
  LxWalletLandingPageDownloadButton = 'uniswap-wallet-landing-page-download-button',
  LxWalletModalDownloadButton = 'uniswap-wallet-modal-download-button',
  LxWalletNavbarMenuDownloadButton = 'uniswap-wallet-navbar-menu-download-button',
  LxWrappedBanner = 'uniswap-wrapped-banner',
  LxWrappedNavbarButton = 'uniswap-wrapped-navbar-button',
  Unwrap = 'unwrap',
