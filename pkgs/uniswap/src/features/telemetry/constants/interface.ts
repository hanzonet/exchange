export enum InterfaceEventName {
  ...
  LxWalletAppDownloadOpened = 'Uniswap Wallet App Download Opened',
  LxWalletConnectModalOpened = 'Uniswap wallet modal opened',
  LxWalletMicrositeOpened = 'Uniswap Wallet Microsite Opened',
