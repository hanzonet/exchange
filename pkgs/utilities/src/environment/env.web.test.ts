...
describe('env', () => {
  ...
  describe('isTestEnv', () => {
    it('should return true', async () => {
      ...
      const { isTestEnv } = await import('@luxfi/utilities/src/environment/env.web')
  ...
  describe('isPlaywrightEnv', () => {
    it('should return false', async () => {
      ...
      const { isPlaywrightEnv } = await import('@luxfi/utilities/src/environment/env.web')
  ...
  describe('isDevEnv', () => {
    it('should return false', async () => {
      ...
      const { isDevEnv } = await import('@luxfi/utilities/src/environment/env.web')
  ...
  describe('isBetaEnv', () => {
    it('should return false', async () => {
      ...
      const { isBetaEnv } = await import('@luxfi/utilities/src/environment/env.web')
  ...
  describe('isProdEnv', () => {
    it('should return false', async () => {
      ...
      const { isProdEnv } = await import('@luxfi/utilities/src/environment/env.web')
