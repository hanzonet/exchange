...
import { addTransaction, deleteTransaction } from '@luxexchange/lx/src/features/transactions/slice'
import {
  ClassicTransactionDetails,
  TransactionStatus,
} from '@luxexchange/lx/src/features/transactions/types/transactionDetails'
import i18n from '@luxexchange/lx/src/i18n'
import { ethersTransactionRequest, getTxFixtures, transactionDetails } from '@luxexchange/lx/src/test/fixtures'
import * as CreateTransactionId from '@luxexchange/lx/src/utils/createTransactionId'
