...
import { isSwapTransactionInfo } from '@luxexchange/lx/src/components/activity/details/types'
...
} from '@luxexchange/lx/src/features/transactions/hooks/useErroredQueuedOrder'
