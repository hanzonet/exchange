import type { WalletEventName } from '@luxexchange/lx/src/features/telemetry/constants'
import type { SwapTradeBaseProperties, UniverseEventProperties } from '@luxexchange/lx/src/features/telemetry/types'
import type { TransactionDetails } from '@luxexchange/lx/src/features/transactions/types/transactionDetails'
