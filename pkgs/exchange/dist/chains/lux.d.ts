...
export declare const liquidityMainnet: {
    blockExplorers: {
        readonly default: {
            ...
            readonly url: "https://explore.main.satschel.com";
        };
    };
    contracts?: {
        [x: string]: import("viem").ChainContract | {
    ...
    nativeCurrency: {
        readonly name: "LQDTY";
        readonly symbol: "LQDTY";
        readonly decimals: 18;
    };
    rpcUrls: {
        readonly default: {
            readonly http: readonly ["https://rpc.main.satschel.com/rpc"];
        };
        readonly public: {
            readonly http: readonly ["https://rpc.main.satschel.com/rpc"];
        };
...
export declare const liquidityTestnet: {
    blockExplorers: {
        readonly default: {
            ...
            readonly url: "https://explore.test.satschel.com";
        };
    };
    contracts?: {
        [x: string]: import("viem").ChainContract | {
    ...
    rpcUrls: {
        readonly default: {
            readonly http: readonly ["https://rpc.test.satschel.com/rpc"];
        };
        readonly public: {
            readonly http: readonly ["https://rpc.test.satschel.com/rpc"];
        };
...
export declare const liquidityDevnet: {
    blockExplorers: {
        readonly default: {
            ...
            readonly url: "https://explore.dev.satschel.com";
        };
    };
    contracts?: {
        [x: string]: import("viem").ChainContract | {
    ...
    rpcUrls: {
        readonly default: {
            readonly http: readonly ["https://rpc.dev.satschel.com/rpc"];
        };
        readonly public: {
            readonly http: readonly ["https://rpc.dev.satschel.com/rpc"];
        };
...
export declare const LIQUIDITY_MAINNET_ID = 8675309;
export declare const LIQUIDITY_TESTNET_ID = 8675310;
export declare const LIQUIDITY_DEVNET_ID = 8675311;
/**
